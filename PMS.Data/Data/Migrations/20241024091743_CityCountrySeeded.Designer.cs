...
namespace PMSWeb.Data.Migrations
{
    ...
    [Migration("20241024091743_CityCountrySeeded")]
    partial class CityCountrySeeded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PMS.Data.Models.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CityId = new Guid("8c139e48-1d8b-402c-be1e-58c18e8f2442"),
                            Name = "Sofia"
                        },
                        new
                        {
                            CityId = new Guid("a984224e-c384-49ef-bf49-01f7bd54346f"),
                            Name = "Varna"
                        },
                        new
                        {
                            CityId = new Guid("8e4b968e-50f4-4bc3-a762-e4725123b45a"),
                            Name = "Pusan"
                        },
                        new
                        {
                            CityId = new Guid("4eb7ea90-edb1-44d0-a45a-80c32aff36cc"),
                            Name = "Shanghai"
                        },
                        new
                        {
                            CityId = new Guid("b1dc5eb3-3f08-4bb6-a299-3deb427ce966"),
                            Name = "Boston"
                        },
                        new
                        {
                            CityId = new Guid("c6682c8e-a7ce-4180-ae5f-295a42387377"),
                            Name = "Paris"
                        },
                        new
                        {
                            CityId = new Guid("0af7364b-871f-48fa-8053-e0657555f479"),
                            Name = "Mestre"
                        },
                        new
                        {
                            CityId = new Guid("6846628f-ecce-440b-bc9b-961967d3fe06"),
                            Name = "Genova"
                        },
                        new
                        {
                            CityId = new Guid("bd3f5fbb-f410-4e1e-bf4e-60940407e049"),
                            Name = "Hamburg"
                        },
                        new
                        {
                            CityId = new Guid("74e96f3d-cbf8-4fc1-950c-786988c84027"),
                            Name = "Vienna"
                        });
                });
            ...
            modelBuilder.Entity("PMS.Data.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CountryId = new Guid("8ea49dff-f677-4dc7-b77f-c3279952c931"),
                            Name = "Bulgaria"
                        },
                        new
                        {
                            CountryId = new Guid("6aec1895-1471-4c3b-add3-842ac2d4397e"),
                            Name = "China"
                        },
                        new
                        {
                            CountryId = new Guid("54bb1e27-0a42-417f-8932-544e6cc12bc3"),
                            Name = "Britain"
                        },
                        new
                        {
                            CountryId = new Guid("2a2fe88c-607a-49ef-a2d5-bee263c3f486"),
                            Name = "Germany"
                        },
                        new
                        {
                            CountryId = new Guid("6779276b-9a3e-4b3f-9ace-c1f262882fbd"),
                            Name = "S.Korea"
                        },
                        new
                        {
                            CountryId = new Guid("b3dce79b-650f-4048-a53d-b2605a5fb593"),
                            Name = "Singapore"
                        },
                        new
                        {
                            CountryId = new Guid("a0bd300e-cf55-45aa-b42d-9ff04f3d2255"),
                            Name = "Poland"
                        },
                        new
                        {
                            CountryId = new Guid("3f810398-5dec-424c-8566-d43ea7dca0fd"),
                            Name = "France"
                        },
                        new
                        {
                            CountryId = new Guid("539d4c47-00a2-404a-af18-4bd8e5d36f57"),
                            Name = "Italy"
                        },
                        new
                        {
                            CountryId = new Guid("c0713127-efac-4a13-b370-40d642825387"),
                            Name = "Spain"
                        });
                });
