...
namespace PMSWeb.Data.Migrations
{
    ...
    [Migration("20241112105053_JobOrderAdded")]
    partial class JobOrderAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PMS.Data.Models.JobOrder", b =>
                {
                    ...
                    b.Property<Guid>("RoutineMaintenanceId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Unique identifier of the routine maintenance selected if any");

                    b.Property<Guid>("SpecificMaintenanceId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("Unique identifier of the specific maintenance selected if any");
                    ...
                    b.HasIndex("SpecificMaintenanceId");
            ...
            modelBuilder.Entity("PMS.Data.Models.JobOrder", b =>
                {
                    ...
                    b.HasOne("PMS.Data.Models.SpecificMaintenance", "SpecificMaintenance")
                        .WithMany("JobOrders")
                        .HasForeignKey("SpecificMaintenanceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("SpecificMaintenance");
                });
